...
*Created by [Abiola Adeshina](https://github.com/Abiorh001) • From the team behind [OmniCoreAgent](https://github.com/omnirexflora-labs/omnicoreagent)*
...
AI agents aren't just an AI problem — they're a **distributed systems problem**.
...
**🎉 Your AI agent is now running and listening for events!**

[**→ Continue with Full Tutorial**](getting-started/quick-start.md)
