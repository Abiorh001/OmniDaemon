...
- **[Callback Pattern](../core-concepts/callback-pattern.md)** - What's in the message
- **[Event-Driven Architecture](../core-concepts/event-driven-architecture.md)** - EDA principles
- **[OmniCore Agent Example](omnicore-agent.md)** - Build agents
- **[Google ADK Example](google-adk-agent.md)** - Build agents
